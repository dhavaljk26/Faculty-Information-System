...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { department_type: @department.department_type, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { department_type: @department.department_type, name: @department.name } }
